...
#include <net/if.h>
#include <sys/ioctl.h>
#include <linux/if_ether.h> // For Linux-specific Ethernet headers
...
int main(int argc, char* argv[]) {
    ...
    while (true)
    {
        ...
        wlan_hdr* wlan = (wlan_hdr*)(frame + ETH_HEADER_LEN);
        ...
        std::cout << "Beacon frame sent successfully\n";
...
// g++ -o fake_beacon fake_beacon.cpp
